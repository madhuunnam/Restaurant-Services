...
public class AdminStatisticsRepository {
	...
	public AdminStatistics getAdminStatistics() {
		...
		String noOfActiveOrdersSQL = "SELECT count(*) FROM Orders";
		...
		String noOfDeliveryOrdersSQL = "SELECT count(*) FROM Customers";
		String deliTotalSQL = "SELECT count(*) FROM Customers";
		String noOfPickUpOrdersSQL = "SELECT count(*) FROM Customers";
		String pickUpTotalSQL = "SELECT count(*) FROM Customers";
		String noOfReserveOrdersSQL = "SELECT count(*) FROM Customers";
		String ReserveTotalSQL = "SELECT count(*) FROM Customers";
		String totalOrdersSQL ="SELECT count(*) FROM Customers";
		String totalAmtSQL ="SELECT count(*) FROM Customers";
